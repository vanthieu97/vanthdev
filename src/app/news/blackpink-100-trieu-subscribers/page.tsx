...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'BLACKPINK 100 triệu subscribers', item: pageUrl },
  ],
};
      ...
      <article className="max-w-6xl mx-auto px-4 py-8 md:px-6 md:py-12">
        <nav aria-label="Breadcrumb" className="mb-8">
          <ol className="flex flex-wrap items-center gap-2 text-sm text-[#6b6b6b] dark:text-slate-400">
            ...
            <li aria-hidden>/</li>
            <li className="text-[#1a1a1a] dark:text-white/95">BLACKPINK 100 triệu subscribers</li>
          </ol>
        </nav>
