...
const pageUrl = `${baseUrl}/news/luat-ai-viet-nam-2026`;
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Luật AI Việt Nam', item: pageUrl },
  ],
};

export default function LuatAIVietNam2026Page() {
  return (
      ...
      <article className="max-w-6xl mx-auto px-4 py-8 md:px-6 md:py-12">
        <nav aria-label="Breadcrumb" className="mb-8">
          <ol className="flex flex-wrap items-center gap-2 text-sm text-[#6b6b6b] dark:text-slate-400">
            ...
            <li aria-hidden>/</li>
            <li className="text-[#1a1a1a] dark:text-white/95">Luật AI Việt Nam</li>
          </ol>
        </nav>
